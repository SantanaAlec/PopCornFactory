...
class Catalogo : AppCompatActivity() {
    ...
    //var gridView: GridView = findViewById(R.id.gridView_catalogo)
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            val iv_pelicula: ImageView = vista.findViewById(R.id.iv_pelicula) as ImageView
            val tv_titulo: TextView = vista.findViewById(R.id.tv_titulo) as TextView

            iv_pelicula.setImageResource(pelicula.image)
            tv_titulo.setText(pelicula.titlulo)

            iv_pelicula.setOnClickListener {
                var intent = Intent(context, detalle_pelicula::class.java)
                intent.putExtra("titulo", pelicula.titlulo)
